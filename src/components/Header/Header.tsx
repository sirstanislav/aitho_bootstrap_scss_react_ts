...
const Header: React.FC = () => {
  ...
  return (
    <Navbar
      ...
      variant="pils"
      bg="white"
      className="p-0 px-2 d-flex flex-nowrap justify-content-start"
      style={{ height: "60px" }}
    >
      <Container className="container flex-row justify-content-start p-0 col-md-8 col-lg-6">
        ...
        <Nav className="me-auto flex-row gap-3 ms-3 fs-6 fw-light d-none d-md-flex align-items-center">
